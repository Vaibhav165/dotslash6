      ...
      <Grid container padding='2em' className='profileDetails_container'>
        <Grid item xs={12} md={9} lg={9}>
          <Stack className={styles.profileDetails}>
            ...
            <img className={styles.profile_image} sc='https://images.unsplash.com/photo-1575089976121-8ed7b2a54265?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8ZGV2ZWxvcGVyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60' alt='profile' />
            <Stack
